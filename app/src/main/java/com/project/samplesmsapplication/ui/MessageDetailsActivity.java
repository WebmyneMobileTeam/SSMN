...
public class MessageDetailsActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    private void processSetFavourite() {
        ...
        DatabaseHelper helper = new DatabaseHelper(MessageDetailsActivity.this);
        ...
        if (isFavourite == false) {
            ...
            Toast.makeText(MessageDetailsActivity.this,"Added To Favourite",Toast.LENGTH_SHORT).show();
    ...
    private void updatePreference() {
        ...
        globalImageview.setBackgroundColor(Color.parseColor(PrefUtils.getBackGroudColor(MessageDetailsActivity.this)));
        imgFavourite.setColorFilter(Color.parseColor(PrefUtils.getBackGroudColorText(MessageDetailsActivity.this)));
        imgThumbsUp.setColorFilter(Color.parseColor(PrefUtils.getBackGroudColorText(MessageDetailsActivity.this)));
        getImgThumbsDown.setColorFilter(Color.parseColor(PrefUtils.getBackGroudColorText(MessageDetailsActivity.this)));
    ...
    private void processCopy() {
        ...
        manager.copyToClipboard(MessageDetailsActivity.this, msgs.get(viewPager.getCurrentItem()).msg_text);
    ...
    private class fetchCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            dbHelper = new DatabaseHelper(MessageDetailsActivity.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            pagerAdapter = new GuideAdapter(MessageDetailsActivity.this, msgs);
    ...
    public class GuideAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            guideImage.setTextSize(TypedValue.COMPLEX_UNIT_SP, PrefUtils.getMessageFontSize(MessageDetailsActivity.this));
            guideImage.setTypeface(PrefUtils.getTypeFace(MessageDetailsActivity.this));
