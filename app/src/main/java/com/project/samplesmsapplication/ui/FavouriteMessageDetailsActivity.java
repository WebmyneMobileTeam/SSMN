...
public class FavouriteMessageDetailsActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    private void processSetFavourite() {
        ...
        DatabaseHelper helper = new DatabaseHelper(FavouriteMessageDetailsActivity.this);
        ...
        if (isFavourite == false) {
            ...
            Toast.makeText(FavouriteMessageDetailsActivity.this,"Added To Favourite",Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(FavouriteMessageDetailsActivity.this,"Removed From Favourite",Toast.LENGTH_SHORT).show();
    ...
    private void updatePreference() {
        ...
        globalImageview.setBackgroundColor(Color.parseColor(PrefUtils.getBackGroudColor(FavouriteMessageDetailsActivity.this)));
        imgFavourite.setColorFilter(Color.parseColor(PrefUtils.getBackGroudColorText(FavouriteMessageDetailsActivity.this)));
        imgThumbsUp.setColorFilter(Color.parseColor(PrefUtils.getBackGroudColorText(FavouriteMessageDetailsActivity.this)));
        getImgThumbsDown.setColorFilter(Color.parseColor(PrefUtils.getBackGroudColorText(FavouriteMessageDetailsActivity.this)));
    ...
    private void processCopy() {
        ...
        manager.copyToClipboard(FavouriteMessageDetailsActivity.this, msgs.get(viewPager.getCurrentItem()).msg_text);
    ...
    private class fetchCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            dbHelper = new DatabaseHelper(FavouriteMessageDetailsActivity.this);
            msgs = dbHelper.getFavouriteMessages();
            dbHelper.close();
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            pagerAdapter = new GuideAdapter(FavouriteMessageDetailsActivity.this, msgs);
    ...
    public class GuideAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            guideImage.setTextSize(TypedValue.COMPLEX_UNIT_SP, PrefUtils.getMessageFontSize(FavouriteMessageDetailsActivity.this));
            guideImage.setTypeface(PrefUtils.getTypeFace(FavouriteMessageDetailsActivity.this));
